...
export class Search extends Component {
    ...
    constructor(){
        super();
        this.state = {
            intents: [], addModuleShow: false, updateModuleShow: false, editModalShow: false, currentIntent: [], searchTerm:''
            ...
            <div>
                ...
                <Table className="table table-bordered hover" id="dataTable">
                    ...
                    <tbody>
                        {
                        intents.map((intents) =>
                            intents.tag.toLowerCase() === this.state.searchTerm.toLowerCase() || intents.tag.includes(this.state.searchTerm.toLowerCase()) ?
                            <tr key={intents.id}>
                                <td>{intents.tag}</td>
